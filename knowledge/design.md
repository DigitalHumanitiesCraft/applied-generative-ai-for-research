...
The published address is `https://digitalhumanitiescraft.github.io/applied-generative-ai-for-research/`. Enabling Pages on the `docs/` folder of the default branch is a repository setting and belongs to the operator.
